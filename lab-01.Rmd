...
#"There are few extreme cases resulting in a higher mean than median"
...
visitors_with_nations %>%
  ...
  count() %>% 
  mutate(
    prop = n / sum(visitors_with_nations$admission == "FREE") 
    )
